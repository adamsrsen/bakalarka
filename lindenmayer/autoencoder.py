...
training_images, testing_images, training_labels, testing_labels = train_test_split(images, labels, test_size=0.2, shuffle=True, random_state=5)
    ...
    for j in range(4):
        ...
        while a < .9:
            model = tf.keras.Sequential([
                ...
                tf.keras.layers.UpSampling2D((2, 2)),
                tf.keras.layers.Conv2D(network_size*2, (3, 3), activation='relu'),
